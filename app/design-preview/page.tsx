    ...
    <div style={{ position: "relative", paddingBottom: 20 }}>
      ...
      <div
        style={{
          ...
          width: 3,
          background:
            "linear-gradient(180deg,rgba(139,92,246,.5),rgba(139,92,246,.05))",
            ...
            >
              ...
              <div
                style={{
                  ...
                  transform:
                    isHovered && isCurrent ? "scale(1.15)" : "scale(1)",
                }}
              >
                  ...
                  >
                    ...
                    <div
                      style={{
                        ...
                        boxShadow: isHovered
                          ? `0 10px 25px ${cat.glow}`
                          : "none",
                        display: "flex",
                        alignItems: "center",
                        justifyContent: "center",
                        fontSize: isFinal ? 32 : 24,
                        transition: "all .2s",
                        position: "relative",
                      }}
                    >
                      ...
                      {i < cat.lessons.length - 1 && (
                        <div
                          style={{
                            ...
                            opacity: 0.3,
                            pointerEvents: "none",
                            display: "none", // Desktop grid makes lines hard, hide for now
                          }}
                        />
                      )}
                    </div>
...
const CONCEPTS = [
  {
    ...
    pros: [
      "Jasna kategoryzacja",
      "Uczucie postępu (RPG)",
      "Zgrabne umieszczenie testów",
    ],
    cons: [
      "Wymaga precyzyjnego rymowania linii SVG",
      "Mniej liniowy niż Quest Path",
    ],
    component: <ConceptD />,
  },
  {
    ...
    pros: [
      "Duże, czytelne kafelki",
      "Gradientowe tło wg stanu",
      "XP odznaki motywują",
    ],
  ...
  },
  {
    ...
    pros: [
      "Cały kurs widoczny bez scrolla",
      "Quick stats motywują",
      "Świetny na mobile",
    ],
    ...
    >
      ...
      <div style={{ textAlign: "center", marginBottom: 36 }}>
        ...
        <p style={{ color: "#666", fontSize: 14, margin: 0 }}>
          Wybierz zakładkę, aby porównać wersję D z poprzednimi
        </p>
      </div>
        ...
        {CONCEPTS.map((c) => (
          <button
            ...
            style={{
              ...
              boxShadow:
                active === c.id ? "0 6px 24px rgba(139,92,246,.4)" : "none",
      ...
      >
        <p style={{ margin: "0 0 10px", fontSize: 14, color: "#ccc" }}>
          {concept.desc}
        </p>
        <div style={{ display: "flex", gap: 24, flexWrap: "wrap" }}>
          <div>
            ...
            {concept.pros.map((p) => (
              <div key={p} style={{ fontSize: 12, color: "#aaa" }}>
                • {p}
              </div>
            ))}
          </div>
      ...
      {/* Concept */}
      <div style={{ maxWidth: 760, margin: "0 auto" }}>{concept.component}</div>
      ...
      >
        Strona tylko do prototypowania ·{" "}
